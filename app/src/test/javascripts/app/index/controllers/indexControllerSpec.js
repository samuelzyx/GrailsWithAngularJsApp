describe('app.index module', function() {

    beforeEach(angular.mock.module('app.index', function() {
    }));
    ...
    describe("IndexController", function() {
        ...
        it("should call the appDataFactory and assign data on success", function() {
            deferred.resolve({data: "Hello"});
            scope.$digest();
            expect(controller.applicationData).toEqual("Hello");
        });

        it("should call the appDataFactory and do nothing on error", function() {
            deferred.reject();
            scope.$digest();
